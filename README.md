...
Bug reports and pull requests are welcome on GitHub at https://github.com/zhisme/hwm_worker. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.
...
Everyone interacting in the HwmWorker project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/zhisme/hwm_worker/blob/master/CODE_OF_CONDUCT.md).
